...
class Shard extends EventEmitter {
    constructor(id, client) {
        ...
        this.id = id;
        this.client = client;
        this.sendIDOnly = client.sendIDOnly;
    ...
    */
    ...
    onPacket(packet) {
        ...
        // console.log(packet.op,packet.t);
        if(packet.s) {
        ...
        switch(packet.op) {
            case GatewayOPCodes.EVENT: {
                if(!this.client.options.disableEvents[packet.t]) {
                    console.log("sent to WSEVENT",packet.t);
                    this.wsEvent(packet);
                }
                break;
            }
    ...
    wsEvent(packet) {
        switch(packet.t) { /* eslint-disable no-redeclare */ // (╯°□°）╯︵ ┻━┻
            ...
            case "MESSAGE_REACTION_ADD": {
                ...
                */
                this.emit("messageReactionAdd", message, packet.d.emoji, !this.sendIDOnly? member || {id: packet.d.user_id} : packet.d.user_id);
                break;
            }
            ...
            case "VOICE_SERVER_UPDATE": {
                ...
                this.client.voiceConnections.voiceServerUpdate(packet.d,packet);
                break;
            }
            case "USER_UPDATE": {
