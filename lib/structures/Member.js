...
class Member extends Base {
    constructor(data, guild, client) {
        ...
        if((this.guild = guild)) {
            this.user = (guild.shard? guild.shard.client:client).users.get(data.id);
            if(!this.user && data.user) {
                this.user = (guild.shard? guild.shard.client:client).client.users.add(data.user, (guild.shard? guild.shard.client:client));
            }
            if(!this.user) {
