...
/**
    ...
    webhookDelete(token) {
        ...
        return this._client.webhookDeleteMessage.call(this._client, this.webhookID, token, this.id);
    }
    ...
    */
    webhookEdit(token, options) {
        ...
        return this._client.webhookEditMessage.call(this._client, this.webhookID, token, this.id, options);
    }
    toJSON(props = []) {
        return super.toJSON([
            "attachments",
